...
numeric values are directly converted; see below.) We use the
[\pkg{BH}](http://dirk.eddelbuettel.com/code/bh.html) package \citep{CRAN:BH} to access
these [Boost](http://www.boost.org) libraries, and rely on
...
\pkg{RApiDatetime} \citep{CRAN:RApiDatetime} package. This is shown in the second
invocation of `anytime()` in the preceding example.
