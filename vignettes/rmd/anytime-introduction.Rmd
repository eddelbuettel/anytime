...
relying on [Boost Date_Time](https://www.boost.org/libs/date_time) for the (efficient,
...
## (cf https://stackoverflow.com/questions/39259184)
...
The actual parsing and conversion is done by two different [Boost](https://www.boost.org/)
...
[\pkg{BH}](https://dirk.eddelbuettel.com/code/bh.html) package \citep{CRAN:BH} to access
these [Boost](https://www.boost.org) libraries, and rely on
[\pkg{Rcpp}](https://www.rcpp.org)
