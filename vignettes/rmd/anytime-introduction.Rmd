...
[Boost Date_Time](http://www.boost.org/doc/libs/1_68_0/doc/html/date_time.html)
...
overriding to `UTC`) the _changing difference_ to UTC is correctly
...
The actual parsing and conversion is done by two
[Boost](http://www.boost.org) libraries.  First,
[Boost lexical_cast](https://www.boost.org/doc/libs/1_68_0/doc/html/boost_lexical_cast.html)
is used to convert from _anything_ to a string representation.  This text
representation is then parsed by
[Boost Date_Time](https://www.boost.org/doc/libs/1_68_0/doc/html/date_time.html) to
...
The [Boost Date_Time](https://www.boost.org/doc/libs/1_68_0/doc/html/date_time.html)
...
does not recognise this and would require "2010-02-04".  Setting the option `useR=TRUE`
switches to the R parser which does recognise this input.
...
datetime conversion for R users.
